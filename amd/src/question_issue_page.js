...
class QuestionIssuePage {
    ...
    constructor(courseid, questionid, issueid) {
        ...
        this.sidebar = new Sidebar('#question-issues-sidebar', true, "left", false, '30%', '1.25rem');
        this.init();
        this.initSidebar()
    }
    ...
    async initSidebar() {
        ...
        window.openSidebarOptions = function () {
            // TODO: add dropdown menu
            console.log("Options in sidebar clicked");
            this.showClosed = true;
            this.filter.push('Closed');
            this.applyFilter();
        }.bind(this);
    ...
    applyFilter() {
        ...
        this.sidebar.getItems().each(function () {
            if (self.filter.indexOf($(this).find(".badge").text()) === -1) {
                $(this).hide();
            }
        });
    }
